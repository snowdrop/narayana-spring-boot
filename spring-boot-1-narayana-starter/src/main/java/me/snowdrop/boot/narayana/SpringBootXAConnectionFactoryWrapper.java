 ...
 */
public class SpringBootXAConnectionFactoryWrapper implements XAConnectionFactoryWrapper {

    private final NarayanaXAConnectionFactoryWrapper delegate;

    public SpringBootXAConnectionFactoryWrapper(NarayanaXAConnectionFactoryWrapper delegate) {
