 ...
 */
public class SpringBootXADataSourceWrapper implements XADataSourceWrapper {

    private final NarayanaXADataSourceWrapper delegate;

    public SpringBootXADataSourceWrapper(NarayanaXADataSourceWrapper delegate) {
        this.delegate = delegate;
    }

    @Override
    public DataSource wrapDataSource(XADataSource dataSource) {
        return delegate.wrapDataSource(dataSource);
    }
