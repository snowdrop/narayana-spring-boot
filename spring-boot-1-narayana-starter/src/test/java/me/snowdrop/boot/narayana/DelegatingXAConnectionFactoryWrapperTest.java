...
public class DelegatingXAConnectionFactoryWrapperTest {
    ...
    public void shouldDelegateToNarayanaWrapper() {
        DelegatingXAConnectionFactoryWrapper wrapper = new DelegatingXAConnectionFactoryWrapper(this.mockDelegate);
